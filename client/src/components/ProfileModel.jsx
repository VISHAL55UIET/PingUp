      ...
      <div className='max-w-2xl sm:py-6 mx-auto'>
        <div className='bg-white rounded-lg shadow p-6'>
          ...
          <form className='space-y-4' onSubmit={handleSaveProfile}>
            ...
            <div className='flex flex-col items-start gap-3'>
              ...
              <div className='group/profile relative mt-2'>
                ...
                <div
                  ...
                  className='absolute hidden group-hover/profile:flex top-0 left-0 right-0 bottom-0 bg-black/20 rounded-full items-center justify-center cursor-pointer'
                >
            ...
            {/* Cover Photo */}
            <div className='group/cover relative flex flex-col items-start gap-3 mt-4'>
              ...
              <div className='group/cover relative'>
                <img
                  ...
                  alt=""
                  className='w-80 h-40 rounded-lg bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200 object-cover mt-2 cursor-pointer'
                  onClick={() => document.getElementById('cover_photo').click()}
                />

                <div
                  onClick={() => document.getElementById('cover_photo').click()}
                  className='absolute hidden group-hover/cover:flex top-0 left-0 right-0 bottom-0 bg-black/20 rounded-lg items-center justify-center cursor-pointer'
                >
                  <Pencil className='w-5 h-5 text-white' />
                </div>
              </div>
