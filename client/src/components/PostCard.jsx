...
const PostCard = ({ post }) => {
    ...
    <div className="bg-white rounded-xl shadow p-4 space-y-4 w-full max-w-2xl">
      <div  onClick={()=>naviagte('/profile/' + post.user._id)} className="inline-flex items-center gap-3 cursor-pointer">
        {/* Fixed typo: profile_picture & removed prfile mistake */}
        <img
        ...
        <div>
          ...
          {/* Improved username line, removed extra dot issue */}
