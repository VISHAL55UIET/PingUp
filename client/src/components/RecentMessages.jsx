...
const RecentMessages = () => {
    ...
    const fetchRecentMessages = async () => {
        try {
            ...
            if (data.success) {
                const groupedMessge = data.messages.reduce((acc, message) => {
                ...
                const sortedMessages = Object.values(groupedMessge).sort(
    ...
    return (
        <div className='bg-white max-w-xs mt-4 p-4 min-h-20 rounded-md shadow text-xs text-slate-800'>
            ...
            <div className='flex flex-col max-h-56 overflow-y-scroll np-scrollbar'>
